...
class CustomerCreateModel(BaseModel):
    ...
    ShippingAddressId : Optional[UUID4 | None] = Field(default=None, description="Shipping address Id of the customer")
    BillingAddressId  : Optional[UUID4 | None] = Field(default=None, description="Billing address Id of the customer")
...
class CustomerResponseModel(BaseModel):
    ...
    ShippingAddressId : Optional[UUID4 | None] = Field(default=None, description="Shipping address Id of the customer")
    ShippingAddress   : Optional[str | None]   = Field(default=None, description="Shipping address of the customer")
    BillingAddressId  : Optional[UUID4 | None] = Field(default=None, description="Billing address Id of the customer")
    BillingAddress    : Optional[str | None]   = Field(default=None, description="Billing address of the customer")
