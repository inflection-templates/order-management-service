...
async def create_customer(model: MerchantCreateModel, db_session = Depends(get_db_session)):
...
async def update_customer(id: str, model: MerchantUpdateModel, db_session = Depends(get_db_session)):
